...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    role: 'consumer' as 'consumer' | 'restaurant_owner',
  });
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900">
            🇮🇳 Join Bharat Low Oil Platform
          </h2>
          <p className="mt-2 text-sm text-gray-600">
            Create your account to start tracking oil consumption
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
              >
                <option value="consumer">Consumer (Track personal consumption)</option>
